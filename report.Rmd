...
The time series $y1$ is plotted in Figure 1. The series appears stationary in mean and variance.
...
```{r, fig.cap="Time series $y_2$ with robust loess smooth for mean and standard deviation." }
